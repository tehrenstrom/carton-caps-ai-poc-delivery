...
# Configure model and token limits (Gemini 1.5 Flash I: 1048576 O: 8000)
...
def generate_response(
    ...
    try:
        ...
        # User-specific and general knowledge base context / Replace with RAG #
        ...
        if not response_text:
            ...
            return "Sorry, I received an empty response from the service. Please try again or contact our support team at support@cartoncaps.com if the problem persists."
